...
import topicApi, { CreateTopic } from "../../../../api/services/topic";
...
const EditTopicModal: FC<Props> = ({ open, handleClose, topic, refetch}) => {
  // hooks
  ...
  const onSubmit = async (values: CreateTopic) => {
    ...
    try {
      await topicApi.update(topic.id, values);
  ...
  return (
    ...
    >
      <Box
        ...
        height="30%"
      >
        <Typography variant="h3">Edit Topic Form</Typography>
        <TextField
          fullWidth
          variant="filled"
          name="name"
